...
{
  "$end", "error", "$undefined", "IDENT", "INTEGER", "DEFBRK", "COLON",
  "OCTAL", "CSR", "IRQ", "INTR", "INIT", "OPEN", "CLOSE", "READ", "WRITE",
  "SEEK", "CONTROL", "IS", "ON", "GETC", "PUTC", "$accept",
  "configuration", "devtypes", "ftypes", "ftype", "dev_list", "devheader",
  "tname", "id", "attr_list", "attr", "devdescriptors", "descriptor",
  "fspec", "dname", "optional_on", YY_NULLPTR
};
#endif
